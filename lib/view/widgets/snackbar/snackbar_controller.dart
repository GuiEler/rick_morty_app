...
class SnackbarController {
  ...
  Future<void> show() => _snackBarQueue._addJob(this);
  ...
  AnimationController _createAnimationController() {
    ...
    assert(snackbar.animationDuration >= Duration.zero, 'Cannot create a animation with zero duration');
  ...
  void _handleStatusChanged(AnimationStatus status) {
    switch (status) {
      ...
      case AnimationStatus.dismissed:
        assert(!_overlayEntries.first.opaque, 'Overlay cannot be opaque');
...
class Queue {
  ...
  Future<T> add<T>(Future<void> Function() job) {
